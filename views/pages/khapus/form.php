<?php
    PageHeader(
        "Penghapusan Aset",
        ($ak=="edit")?"Perubahan dokumen berita acara dan validasi penghapusan aset secara resmi":"Pembuatan dokumen berita acara dan validasi penghapusan aset secara resmi",
                ...
                PageContentForm(
                    <<<a
                        <form method="POST" autocomplete="off">
                            <div class="mb-4">
                                <label class="form-label fw-bold text-secondary" style="font-size: 0.75rem; letter-spacing: 0.5px; text-transform: uppercase;">Nomor Penghapusan</label>
