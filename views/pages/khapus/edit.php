<div class="row align-items-center mb-4 g-3">
    <div class="col-md-6">
        ...
        <p class="text-secondary small mb-0 mt-1">Perubahan dokumen berita acara dan validasi penghapusan aset secara resmi</p>
    </div>
    
    <div class="col-md-6">
        <div class="d-flex gap-2 justify-content-md-end">
            <div class="d-flex gap-2 justify-content-md-end">
                <a href="?pg=<?= $pg ?>&fl=list" class="btn btn-primary d-flex align-items-center gap-2 shadow-sm px-4 rounded-3 fw-medium" style="background-color: #4338ca; border: none; padding-top: 0.6rem; padding-bottom: 0.6rem;">
