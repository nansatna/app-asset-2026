                    ...
                    <<<a
                        <form method="POST" autocomplete="off">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama" class="form-control form-control-lg bg-light border-0 fs-6" placeholder="Contoh : JBRT001" style="border-radius: 10px;" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label small fw-bold text-secondary text-uppercase" style="letter-spacing: 0.5px;">Lokasi</label>
        ...
        <div class="col-lg-8">
             <?php
                ...
                PageContentTabel(
                    ...
                    <<<tr
                        <tr>
                            <td class="ps-4 py-3 fw-bold text-dark small">JBRT001</td>
                            <td class="ps-4 py-3 fw-bold text-dark small">Kota Bandung</td>
