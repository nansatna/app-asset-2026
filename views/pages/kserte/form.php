            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden" style="background: #fff;">
                <div class="card-body p-4">
                    <form method="POST" autocomplete="off">
                        ...
                        <div>
                            <button type="submit" name="btn" value="Simpan" class="btn btn-success fw-bold py-2 shadow-sm"  style="border:none;">
                                <i data-lucide="file-plus" style="width:18px" class="me-1"></i> Baru
                            </button>
                            
                            <button type="submit" name="btn" value="Batal" class="btn btn-primary fw-bold py-2 shadow-sm" style="border:none;">
                                <i data-lucide="circle-check-big" style="width:18px" class="me-1"></i> Selesai
                            </button>

                            <?= button("btn","Batal","primary","circle-check-big","") ?>

                            <?= button("btn","Cancel","warning","user","") ?>

                            <a href="#" onclick="cetakDariFile('<?= $ArrDt['kode'] ?>','serte')"  class="btn btn-info text-white fw-bold py-2 shadow-sm" style="border:none; border-radius: 12px;">
