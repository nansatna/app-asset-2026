                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-4">
                        ...
                        <div class="position-relative">
                            <input type="text" name="kode_aset" class="form-control form-control-lg bg-light border-0 fs-6 ps-5" placeholder="AST-001" style="border-radius: 10px;" required>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="position-relative">
                            <input type="text" name="nama_aset" class="form-control form-control-lg bg-light border-0 fs-6 ps-5" placeholder="Contoh: Laptop Dell Latitude 7490" style="border-radius: 10px;" required>
                            <div class="position-absolute top-50 start-0 translate-middle-y ps-3 text-muted">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="position-relative">
                            <select name="lokasi" class="form-select form-select-lg bg-light border-0 fs-6 ps-5 text-dark" style="border-radius: 10px; cursor: pointer;" required>
                                ...
                                <option value="kantor_pusat">Kantor Pusat - Lt. 1</option>
                                <option value="gudang_a">Gudang Logistik A</option>
                                <option value="ruang_meeting">Ruang Meeting Utama</option>
                                <option value="cabang_barat">Cabang Jakarta Barat</option>
                            </select>
                            <div class="position-absolute top-50 start-0 translate-middle-y ps-3 text-muted">
